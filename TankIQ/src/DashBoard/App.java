...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(50, 66, 70));

        jLabel1.setFont(new java.awt.Font("Shree Devanagari 714", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("TankIQ");

        jButton1.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jButton1.setText("Configure Sensor");
        ...
        jButton5.setText("Load / Save Config");
        ...
        jPanel1.setBackground(new java.awt.Color(114, 173, 238));

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("TankIQ Dashboard");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jDesktopPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 546, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        Load Table
        jDesktopPane1.removeAll();
        try{
            Load_Table loadTable = new Load_Table();
            jDesktopPane1.add(loadTable);
            jDesktopPane1.moveToFront(loadTable);
            loadTable.setSize(jDesktopPane1.getWidth(),jDesktopPane1.getHeight());
            loadTable.setLocation(0,0);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        jDesktopPane1.removeAll();
        try{
            Connect_Port  connectPort = new Connect_Port();
            jDesktopPane1.add(connectPort);
            jDesktopPane1.moveToFront(connectPort);
            connectPort.setSize(jDesktopPane1.getWidth(),jDesktopPane1.getHeight());
            connectPort.setLocation(0,0);
            connectPort.setVisible(true);
        }catch(Exception e){
            e.printStackTrace();
        }
